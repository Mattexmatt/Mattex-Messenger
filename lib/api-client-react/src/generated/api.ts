 ...
 */
export const getGetPodcastsUrl = () => {
  return `/api/podcasts`;
};
...
export const getPodcasts = async (
  ...
  return customFetch<Podcast[]>(getGetPodcastsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetPodcastsQueryKey = () => {
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getPodcasts>>> = ({
    signal,
...
export type GetPodcastsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPodcasts>>
>;
...
>(options?: {
  ...
  const queryOptions = getGetPodcastsQueryOptions(options);
...
export const createPodcast = async (
  ...
  return customFetch<Podcast>(getCreatePodcastUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(createPodcastRequest),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CreatePodcastRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type CreatePodcastMutationResult = NonNullable<
  Awaited<ReturnType<typeof createPodcast>>
>;
export type CreatePodcastMutationBody = BodyType<CreatePodcastRequest>;
 ...
 */
export const getGetMemesUrl = (params?: GetMemesParams) => {
  const normalizedParams = new URLSearchParams();
...
export const getMemes = async (
  ...
  return customFetch<Meme[]>(getGetMemesUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getGetMemesQueryKey = (params?: GetMemesParams) => {
  return [`/api/memes`, ...(params ? [params] : [])] as const;
};

export const getGetMemesQueryOptions = <
  TData = Awaited<ReturnType<typeof getMemes>>,
  TError = ErrorType<unknown>,
>(
  params?: GetMemesParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getMemes>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetMemesQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getMemes>>> = ({
    signal,
  }) => getMemes(params, { signal, ...requestOptions });
...
export type GetMemesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMemes>>
>;
export type GetMemesQueryError = ErrorType<unknown>;
...
>(
  ...
  const queryOptions = getGetMemesQueryOptions(params, options);
...
export const createMeme = async (
  ...
  return customFetch<Meme>(getCreateMemeUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export type CreateMemeMutationError = ErrorType<unknown>;
 ...
 */
export const getLikeMemeUrl = (memeId: number) => {
...
export const likeMeme = async (
  ...
  return customFetch<LikeResponse>(getLikeMemeUrl(memeId), {
    ...options,
    method: "POST",
  });
};

export const getLikeMemeMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof likeMeme>>,
    TError,
    { memeId: number },
    TContext
  >;
...
> => {
  ...
  > = (props) => {
    ...
    return likeMeme(memeId, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type LikeMemeMutationResult = NonNullable<
  Awaited<ReturnType<typeof likeMeme>>
>;

export type LikeMemeMutationError = ErrorType<unknown>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getLikeMemeMutationOptions(options));
};
